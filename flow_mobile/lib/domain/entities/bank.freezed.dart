...
abstract class $BankCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String logoPath});
}
...
class _$BankImpl implements _Bank {
  const _$BankImpl({required this.name, required this.logoPath});
  ...
  @override
  String toString() {
    return 'Bank(name: $name, logoPath: $logoPath)';
  }
...
abstract class _Bank implements Bank {
  const factory _Bank(
      ...
      required final String logoPath}) = _$BankImpl;
