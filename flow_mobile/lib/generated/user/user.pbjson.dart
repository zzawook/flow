...
const $core.Map<$core.String, $core.dynamic> UserServiceBase$json = {
  ...
  '2': [
    {
      '1': 'GetUserProfile',
      '2': '.sg.flow.user.v1.GetUserProfileRequest',
      '3': '.sg.flow.user.v1.UserProfile'
    },
    {
      '1': 'GetUserPreferenceJson',
      '2': '.sg.flow.user.v1.GetUserPreferenceJsonRequest',
      '3': '.sg.flow.user.v1.GetUserPreferenceJsonResponse'
    },
    {
      '1': 'UpdateUserProfile',
      '2': '.sg.flow.user.v1.UpdateUserProfileRequest',
      '3': '.sg.flow.user.v1.UserProfile'
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
  ...
  '.sg.flow.user.v1.GetUserProfileRequest': GetUserProfileRequest$json,
  '.sg.flow.user.v1.UserProfile': UserProfile$json,
  '.google.protobuf.Timestamp': $0.Timestamp$json,
  '.google.protobuf.StringValue': $1.StringValue$json,
  '.sg.flow.user.v1.GetUserPreferenceJsonRequest':
      GetUserPreferenceJsonRequest$json,
  '.sg.flow.user.v1.GetUserPreferenceJsonResponse':
      GetUserPreferenceJsonResponse$json,
  '.sg.flow.user.v1.UpdateUserProfileRequest': UpdateUserProfileRequest$json,
};

/// Descriptor for `UserService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List userServiceDescriptor = $convert.base64Decode(
    'CgtVc2VyU2VydmljZRJWCg5HZXRVc2VyUHJvZmlsZRImLnNnLmZsb3cudXNlci52MS5HZXRVc2'
    'VyUHJvZmlsZVJlcXVlc3QaHC5zZy5mbG93LnVzZXIudjEuVXNlclByb2ZpbGUSdgoVR2V0VXNl'
    'clByZWZlcmVuY2VKc29uEi0uc2cuZmxvdy51c2VyLnYxLkdldFVzZXJQcmVmZXJlbmNlSnNvbl'
    'JlcXVlc3QaLi5zZy5mbG93LnVzZXIudjEuR2V0VXNlclByZWZlcmVuY2VKc29uUmVzcG9uc2US'
    'XAoRVXBkYXRlVXNlclByb2ZpbGUSKS5zZy5mbG93LnVzZXIudjEuVXBkYXRlVXNlclByb2ZpbG'
    'VSZXF1ZXN0Ghwuc2cuZmxvdy51c2VyLnYxLlVzZXJQcm9maWxl');
