...
class Account extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.Bank>(4, _omitFieldNames ? '' : 'bank', subBuilder: $0.Bank.create)
  ...
  @$pb.TagNumber(4)
  $0.Bank get bank => $_getN(3);
  @$pb.TagNumber(4)
  set bank($0.Bank value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasBank() => $_has(3);
  @$pb.TagNumber(4)
  void clearBank() => $_clearField(4);
  @$pb.TagNumber(4)
  $0.Bank ensureBank() => $_ensure(3);
}
