...
class RefreshFailedScreen extends StatelessWidget {
  const RefreshFailedScreen({super.key});
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: Center(
              child: Text(
                "Bank refresh attemp failed. Please try again.",
            ...
            child: FlowCTAButton(
              ...
              onPressed: () {
                StoreProvider.of<FlowState>(
                  context,
                  listen: false,
                ).dispatch(skipFirstAndLinkBankThunk());
              },
            ),
          ),
        ],
