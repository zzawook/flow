...
class RefreshBankScreen extends StatefulWidget {
  final String url;
  final Bank bank;

  const RefreshBankScreen({
    super.key,
    required this.url,
    required this.bank,
  });
  ...
  @override
  State<StatefulWidget> createState() => _RefreshBankScreenState();
}

class _RefreshBankScreenState extends State<RefreshBankScreen> {
