...
class ManageNotificationScreen extends ConsumerWidget {
                      ...
                      children: [
                        ...
                        SettingTab(
                          ...
                          trailing: NotificationToggleSwitch(
                            ...
                            onToggle: (toggleStatus) {
                              ref.read(settingsNotifierProvider.notifier)
                                  .togglePeriodicReminderNotification();
                            },
                          ),
                          onTap: () {},
                        ),
                              ...
                              children: [
                                SettingTab(
                                  ...
                                  trailing: NotificationToggleSwitch(
                                    ...
                                    onToggle: (toggleStatus) {
                                      ref.read(settingsNotifierProvider.notifier)
                                          .togglePeriodicReminderAutoNotification();
                                    },
                                  ),
                                  onTap: () {},
                                ),
