...
public class TransactionHistoryQueryStore {
        ...
        public static final String FIND_TRANSACTION_BETWEEN_DATES = "SELECT th.id, " +
                        "th.transaction_reference, " +
                        "th.account_id, " +
                        "th.card_id, " +
                        "th.transaction_date, " +
                        ...
                        "JOIN banks b ON acc.bank_id = b.id " +
                        "LEFT JOIN cards c ON th.card_id = c.id " +
                        "WHERE th.transaction_date BETWEEN ? AND ? AND"
                        + " acc.user_id = ?"
                        + " ORDER BY th.transaction_date DESC, th.transaction_time DESC"
                        + " LIMIT ?";
                        
        public static final String FIND_TRANSACTION_DETAIL_BY_ID = "SELECT th.id, " +
                        "th.transaction_reference, " +
                        "th.account_id, " +
                        "th.card_id, " +
                        "th.transaction_date, " +
