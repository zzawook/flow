...
class TransactionHistoryController(private val transactionService: TransactionHistoryService) {
        ...
        @GetMapping("/lastMonthTransaction")
        ...
        suspend fun getTransactionDetails(
                ...
                return ResponseEntity.ok(
                        transactionService.getTransactionDetails(userId, transactionId)
                )
        }

        @GetMapping("/transaction_within_range")
