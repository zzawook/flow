...
class FlowSecurityConfig {
    ...
    fun filterChain(
        ...
        val refreshTokenFilter = tokenAuthenticationFilter(flowTokenService, authManager).apply {
        ...
        http
            ...
            .addFilterBefore(accessTokenValidationFilter, RefreshTokenAuthentcationFilter::class.java)
    ...
    @Bean
    fun mockAuthenticationFilter(): Filter = MockAuthenticationFilter()
